...
/**
 * Tipos de documento visibles en dashboards/informes.
 * REPORTES = 'NO' se excluye; NULL o vacío se trata como 'SI'.
 * Prefijo de alias típico: t (TIPODOCUMENTOS).
 */
const SQL_TIPODOC_REPORTES_SI = `UPPER(ISNULL(NULLIF(LTRIM(RTRIM(t.REPORTES)), ''), 'SI')) = 'SI'`;
