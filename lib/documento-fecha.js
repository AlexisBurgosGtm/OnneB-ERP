 ...
 * DOCPRODUCTOS.LASTUPDATE no se modifica aquí: debe ser la fecha del día (GETDATE).
 */
function parseFechaInput(raw) {
  ...
  return {
    ...
    mes,
    dia,
    fecha: localDateOnly(anio, mes, dia),
  };
}
...
module.exports = { parseFechaInput, applyDocumentoFecha, nowParts, localDateOnly };
