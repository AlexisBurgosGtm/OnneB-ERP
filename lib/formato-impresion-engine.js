...
const DEFAULT_HTML = `<div class="doc-print-sheet">
  ...
  <table class="doc-lines-table">
    ...
    <tbody>
      ...
      {{/LINES}}
      {{^LINES}}
      <tr><td colspan="5" class="text-center">Sin líneas</td></tr>
      {{/LINES}}
    </tbody>
  </table>
...
body{font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.25;color:#111;padding:2mm}
.fel-ticket{width:72mm;max-width:72mm;margin:0 auto;box-sizing:border-box}
