...
/**
 * Compras y notas de crédito a proveedores: no forman parte del efectivo de caja.
 * Se excluyen del conteo y de la marcación CORTE/NOCORTE aunque tuvieran CODCAJA.
 */
const TIPODOC_EXCLUIDOS_CORTE_CAJA = ['COM', 'COP', 'DVP'];
