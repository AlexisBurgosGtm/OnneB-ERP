...
const FILTROS_DOCUMENTOS = {
  credito: " AND ISNULL(d.CONCRE, 'CON') = 'CRE'",
  contado: " AND ISNULL(d.CONCRE, 'CON') <> 'CRE'",
  tarjeta: ' AND ISNULL(d.FPAGO_TARJETA, 0) > 0',
  deposito: ' AND ISNULL(d.FPAGO_DEPOSITO, 0) > 0',
  cheque: ' AND ISNULL(d.FPAGO_CHEQUE, 0) > 0',
};
