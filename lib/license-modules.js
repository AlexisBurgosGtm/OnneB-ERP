...
const API_PREFIX_RULES = [
  ...
  { prefix: '/api/facturacion', module: 'operaciones', menus: ['facturacion', 'facturas-electronicas', 'facturacion-completa'] },
  { prefix: '/api/fel', module: 'operaciones', menus: ['facturas-electronicas', 'facturacion-completa'] },
