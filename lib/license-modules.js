 ...
 *
 * FUENTE DE VERDAD del generador (GENERADOR LICENCIAS):
...
/** Menús siempre disponibles (activar licencia, inicio). */
const CORE_MENUS = ['inicio', 'licencia'];
...
const API_PREFIX_RULES = [
  ...
  { prefix: '/api/fraccionamiento-fac', module: 'operaciones', menus: ['fraccionamiento-fac'] },
  { prefix: '/api/facturacion', module: 'operaciones', menus: ['facturacion'] },
  { prefix: '/api/fel', module: 'operaciones', menus: ['facturas-electronicas'] },
  ...
  { prefix: '/api/traslados/recibir', module: 'traslados', menus: ['recibir-traslado'] },
  {
    ...
    module: 'inventarios',
    menus: ['inventario', 'inventario-retroactivo', 'actualizacion-inventario', 'entradas-inventario', 'salidas-inventario'],
  },

  { prefix: '/api/documentos', module: 'archivo', menus: ['documentos'] },
  ...
  { prefix: '/api/nomina/vales', module: 'rh', menus: ['nomina-vales'] },
  {
    prefix: '/api/nomina',
    module: 'rh',
  ...
  { prefix: '/api/developer', module: 'configuraciones', menus: ['developer'] },
