...
const API_PREFIX_RULES = [
  ...
  { prefix: '/api/pendientes-entrega', module: 'despacho', menus: ['pendientes-entrega'] },
  ...
  { prefix: '/api/facturacion', module: 'operaciones', menus: ['facturacion', 'facturas-electronicas', 'facturas-electronicas-extraordinarias', 'facturacion-completa', 'asignacion-pedidos'] },
  { prefix: '/api/fel', module: 'operaciones', menus: ['facturas-electronicas', 'facturas-electronicas-extraordinarias', 'facturacion-completa', 'asignacion-pedidos'] },
  ...
  { prefix: '/api/fel-xml', module: 'reportes', menus: ['impresion-xml-fel'] },
  { prefix: '/api/control-fletes', module: 'reportes', menus: ['control-fletes'] },
  ...
  { prefix: '/api/conta-libros-manual', module: 'contabilidad', menus: ['ventas-manuales', 'compras-manuales'] },
  { prefix: '/api/libro-diario', module: 'contabilidad', menus: ['libro-diario'] },
  { prefix: '/api/conta-asientos', module: 'contabilidad', menus: ['partidas-diario'] },
  ...
  { prefix: '/api/whatsapp', module: 'configuraciones', menus: ['config-general'] },
